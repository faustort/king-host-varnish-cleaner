 ...
 * Description:       This plugin try to clear Varnish Cache based on King Host documentation
 * Version:           1.0.2
 ...
 */
define('KING_HOST_VARNISH_CLEANER_VERSION', '1.0.2');

/**
 * Define plugin base.
 */
define('KING_HOST_VARNISH_CLEANER_PLUGIN_BASE', plugin_basename(__FILE__));
